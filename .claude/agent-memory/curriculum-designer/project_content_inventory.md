---
name: Content inventory — licks, rhythms, songs, hand independence
description: What data content exists in src/lib/data/ as of 2026-03-29
type: project
---
...
- stride-left-hand (LH stride pattern)
- blues-shuffle-right (RH blues shuffle)
- country-alternating-bass (LH alternating bass — NOT used in main curriculum)
- jazz-turnaround-lh (LH turnaround)
- dorian-mode-run (D Dorian, RH)
- gospel-chord-run (gospel chord run)
- funky-bass-line (LH funk bass)
- latin-montuno-bass (LH montuno)
...
- funk-basic (funk groove)
- herbie-funk (Herbie Hancock style, advanced)
- latin-montuno (Latin pattern)
- blues-shuffle (triplet shuffle)
- country-waltz (3/4 waltz — NOT used in main curriculum)
- blues-shells (root-fifth LH + shell RH on 2 and 4)
...
- blue-bossa (Latin, two key centres)
- all-the-things-you-are (multi-key ii-V-I)
- misty (ballad, rich harmony)
...
- stride-left-hand lick unused in v2.0 curriculum (available in Gym).
