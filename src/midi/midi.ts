...
export const noteFullNameToNote = (noteFullName: NoteFullName): Note =>
	noteFullName.slice(0, -1) as Note;
...
export const majorScales = AllNotes.reduce(
	(acc, value) => {
...
export const minorScales = AllNotes.reduce(
	(acc, value) => {
 ...
 */
export function midiNoteToNoteName(midiNote: MidiNote): NoteFullName {
