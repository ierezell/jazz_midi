...
import type { Chord, ChordType, MidiNote, Note, NoteEvent, NoteFullName } from '../../midi/midi';

export type { Chord, ChordType, MidiNote, Note, NoteEvent, NoteFullName };

// Chord tone coloring types
    export type { ChordToneColors, ChordToneInfo, ChordToneRole } from './chordTones';
...
export interface BaseKeyboardProps {
	...
	interactive?: boolean;
	showLabels?: boolean;
	chordToneInfo?: import('./chordTones').ChordToneInfo[];
