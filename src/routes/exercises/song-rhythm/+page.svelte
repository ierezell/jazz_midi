...
<script lang="ts">
	...
	import { generateAnnotations, getBeginnerChordAnnotation, getVoicingSuggestion } from '$lib/ScoreAnnotationUtils';
	import { createBarsFromChords, validateRhythmNote, isBarComplete, getRestartBarIndex, formatBarProgress, getAutoRestartMessage, getWaitForKeyMessage, generateRhythmExerciseFromSong } from '$lib/RhythmExercise';
	...
	function validateNoteEvent(
		...
		const description = 'Practice songs bar by bar with rhythm. Play each chord or note on the beat. Mistakes will either auto-restart from the previous bar or pause until you press a key.';
	</script>
			...
			<div class="song-rhythm-exercise">
				...
				<div class="progress-section">
					...
					<div class="progress-bar">
						<div class="progress-fill" style="width: {(currentBarIndex / Math.max(1, bars.length - 1)) * 100}%"></div>
					</div>
				...
				<div class="settings-section">
					<div class="setting-group">
						...
						<span class="setting-hint">
							{mistakeMode === 'auto-restart' ? 'Gives 4 beats to refocus' : 'Press any key to continue'}
						</span>
					</div>
