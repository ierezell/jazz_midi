...
import type { BarData, RhythmConfig, RhythmValidationResult, MistakeMode } from '../../../lib/types/rhythm';
import type { MidiNote, NoteEvent } from '../../../lib/types/types';
import { validateNoteTiming } from '../../../lib/musicValidation';
import type { TempoValidation, BeatTiming } from '../../../lib/types/exercise-api';
