...
import type { MidiNote, Note, ChordType } from '../../../lib/types/types';
import type { ScaleMode, ChordVoicing, Inversion } from '../../../lib/types/notes';
...
export function generateRandomCard(root: Note, forcedType?: FlashCardType): FlashCard {
	...
	if (type === 'note') {
		...
		// The user said "Flashcards and random should be the same page. Please merge them. The goal is to flash exercises randomly."
